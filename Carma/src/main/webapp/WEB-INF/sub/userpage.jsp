...
<body>
	...
	<div class="jumbotron">
		...
		<hr class="my-4">
		<p class="lead" align="center">What shameful contribution will you
			make today?</p>
	</div>

	<!--  /JumboTron-->
	<!-- profile photo -->
	<div class="flex row bg-primary rounded text-center"
		style="align-content: center; height: 700px; padding-left: 5em;">
		<div
			class="col-4 imagecontainer shadow-lg rounded bg-light  mh-100 rounded"
			style="padding: 1em;">
						...
						<div class="modal-body">
							<div class="row">
								<form method="POST" action="updateUserPhoto.do">
									URL : <input type="text" name="image" /><br> <input
		...
		<!-- info -->
		<div
			class="col-5 text-white bg-light rounded shadow-lg table-striped mh-80 h-80"
			style="padding: 2em">
			<table class="table">
				<thead>
					<tr>
				...
				<tr>
					<td># of Comments: ${loggedInUser.comments.size()}</td>
				<tr>
					<td># of Carma Posts: ${listOfPF.size()}</td>
				<tr>
					<c:choose>
	...
	<div>
		<br>
		<h2 style="text-align: center">${fn:length(listOfPF)} Carma Posts
			Uploaded</h2>
		<br>
		<div class="container-fluid w-100">
			<div class="row">
				<c:forEach var="pf" items="${listOfPF }" varStatus="status">
					<div class="col-3 d-flex mw-30">
													...
													<div class="row">
														<div class="col-md-6">
															...
															<form:label path="licensePlate"
																placeholder="You must disguise license plate in photo">License plate:</form:label>
														...
														<div class="col-md-6">
															...
															<form:input maxlength="2" placeholder="ex: CA"
																path="state" value="${pf.location.state }" />
															<form:label path="zip">Zip Code:</form:label>
															<form:input maxlength="5" path="zip"
																value="${pf.location.zip }" />
					...
					<form:form action="create.do" method="POST"
						...
						<div class="row">
							<div class="col-md-6">
								...
								<form:input path="licensePlate" maxlength="10"
									placeholder="You must disguise license plate in photo" />
							</div>
							<div class="col-md-6">
								<form:label path="name">Location:</form:label>
	...
	<!--  -->
	<div
		style="display: flex; align-items: center; justify-content: center; margin-top: 2em; position: relative; z-index: 100;">
				...
				<div class="clearfix center"
					...
					<c:forEach items="${loggedInUser.getComments() }" var="comment">
						<div class="shadow-sm rounded bg-light"
							...
							<h2>
								<a href="findParkingFail.do?val=${comment.parkingFail.id}">
									${ comment.parkingFail.title}</a>
							</h2>
							${comment.dateCreated }
							<hr>
